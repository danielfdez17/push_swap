...
void	rra(t_stack_node **a, t_bool print) //Rotate the bottom of `a` to the top of the stack and print the instruction
{
	rev_rotate(a);
	if (!print)
		ft_printf("rra\n");
...
void	rrb(t_stack_node **b, t_bool print) //Rotate the bottom of `b` to the top of the stack and print the instruction
{
	rev_rotate(b);
	if (!print)
		ft_printf("rrb\n");
...
void	rrr(t_stack_node **a, t_stack_node **b, t_bool print) //Stimultaneously rotate both stacks' bottom nodes to the top of their stacks, halving the cost of instructions
{
	rev_rotate(a);
	rev_rotate(b);
	if (!print)
